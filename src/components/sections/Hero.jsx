...
export default function Hero() {
  return (
    <section className="relative lg:min-h-[90vh] flex items-center px-6 sm:px-8 lg:px-12 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <span className="tag mb-6 inline-block">
              v2.0 — Completely Offline
            </span>

            <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-extrabold tracking-tight leading-[1.1] text-[var(--color-black)] mb-6">
              Your Smart <span className="gradient-text">Kanban Desktop</span>
              <br />
              App, No Account Needed
            </h1>

            <p className="text-lg text-[var(--color-text-light)] leading-relaxed mb-10 max-w-md">
              Nura Manager is a fully offline Kanban productivity app with
              intelligent agents, AI chat control, and zero cloud dependency.
              Your data stays on your machine. But we own the Software
            </p>
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--color-ginger)]/10 border border-[var(--color-ginger)]/20 mt-2">
              <span className="w-2 h-2 rounded-full bg-orange-500" />
              <p className="text-sm sm:text-base text-[var(--color-black)] font-medium">
              ...
              <div className="relative rounded-2xl overflow-hidden bg-white shadow-xl shadow-black/[0.04] ring-1 ring-black/5">
                ...
                <div className="flex items-center gap-2 px-5 py-3.5 bg-gray-50 border-b border-gray-100">
                  ...
                  <span className="ml-3 text-xs text-gray-500 font-medium">
                    Nura Manager — By Ghulam Haider Productions
                  </span>
                </div>
