...
export default function SkeletonLoader({ children }) {
  ...
  return (
    <div className="relative min-h-screen bg-[var(--color-cream)]">
      ...
      {show && (
        <div className="fixed inset-0 z-50 overflow-hidden bg-[var(--color-cream)] flex flex-col items-center justify-center">
          <motion.div
            initial={{ x: '-110vw' }}
            animate={{ x: '110vw' }}
          ...
          >
            <svg viewBox="0 0 130 130" className="w-full h-full" fill="none">
              <style>{`
                ...
                .leye { animation: lk 3s ease-in-out infinite; }
